...
import { coordsHistory, sceneX, state } from "../state/state";
import { drawDashedLine, drawLine, drawPoint } from "../utils/draw";
...
const point = {
  ...
  draw: function () {
    ...
    if (!floorPointIntersection) {
      ...
      const isNextYHigherThenSibling =
